...
|:-------------|:-------------|:--------|:-------------|:----------|:-----|:---|:-------------------|
|counts_orig   |counts_orig   |meta     |              |matrix     |32883 |48  |2021-04-09 10:06:20 |
|counts        |counts        |assay    |counts_orig   |matrix     |32883 |48  |2021-04-09 10:06:20 |
|design_orig   |design_orig   |meta     |              |data.frame |48    |10  |2021-04-09 10:06:20 |
|design        |design        |col      |design_orig   |data.frame |48    |10  |2021-04-09 10:06:20 |
|geneData_orig |geneData_orig |meta     |              |data.frame |32883 |8   |2021-04-09 10:06:20 |
|geneData      |geneData      |row      |geneData_orig |data.frame |32883 |8   |2021-04-09 10:06:20 |
|granges_orig  |granges_orig  |meta     |geneData_orig |GRanges    |32883 |NA  |2021-04-09 10:06:20 |
|granges       |granges       |row      |geneData      |GRanges    |32883 |NA  |2021-04-09 10:06:20 |
...
During a workflow, a DGEobj typically gets filtered down to remove samples that fail QC or non-expressed genes. The `resetDGEobj` function produces a new DGEobj with the original unfiltered data. Resetting can only be done on valid DGEobjs. 

```r 
# view the DGEobj dimensions
dim(dgeObj)
```
...
```r
# subset the DGEobj 
dgeObj_subset <- dgeObj[c(1:10), ]

#view new dimensions for the object
dim(dgeObj_subset)
```
...
DGEobj_reset <- resetDGEobj(dgeObj)

# view the restored dimensions
dim(DGEobj_reset)
```
...
|granges_orig  |granges_orig  |meta     |geneData_orig |GRanges    |32883 |NA  |2021-04-09 10:06:20 |
|granges       |granges       |row      |geneData      |GRanges    |32883 |NA  |2021-04-09 10:06:20 |
|AlignmentQC   |alignQC       |col      |              |data.frame |48    |172 |2021-04-09 10:06:21 |
|normTMM       |DGEList       |assay    |counts        |DGEList    |32883 |48  |2021-04-09 10:06:22 |
...
|ItemName            |ItemType            |BaseType |Parent              |Class      |Row   |Col |DateCreated         |
|:-------------------|:-------------------|:--------|:-------------------|:----------|:-----|:---|:-------------------|
|intensity_orig      |intensity_orig      |meta     |                    |matrix     |32883 |48  |2021-04-09 10:06:24 |
|intensity           |intensity           |assay    |intensity_orig      |matrix     |32883 |48  |2021-04-09 10:06:24 |
|design_orig         |design_orig         |meta     |                    |data.frame |48    |10  |2021-04-09 10:06:24 |
|design              |design              |col      |design_orig         |data.frame |48    |10  |2021-04-09 10:06:24 |
|metaboliteData_orig |metaboliteData_orig |meta     |                    |data.frame |32883 |8   |2021-04-09 10:06:24 |
|metaboliteData      |metaboliteData      |row      |metaboliteData_orig |data.frame |32883 |8   |2021-04-09 10:06:24 |
|granges_orig        |granges_orig        |meta     |metaboliteData_orig |GRanges    |32883 |NA  |2021-04-09 10:06:24 |
|granges             |granges             |row      |metaboliteData      |GRanges    |32883 |NA  |2021-04-09 10:06:24 |
...
##  $ type             : Named chr [1:37] "row" "col" "assay" "meta" ...
##   ..- attr(*, "names")= chr [1:37] "row" "col" "assay" "meta" ...
##  $ uniqueType       : chr [1:18] "counts" "counts_orig" "design" "design_orig" ...
##  $ allowedLevels    : chr [1:4] "gene" "isoform" "exon" "affy"
##  $ primaryAssayNames: Named chr [1:4] "counts" "counts" "counts" "AffyRMA"
##   ..- attr(*, "names")= chr [1:4] "gene" "isoform" "exon" "affy"
